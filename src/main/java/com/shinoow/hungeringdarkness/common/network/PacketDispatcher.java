...
public class PacketDispatcher
{
	 ...
	 */
	private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(HungeringDarkness.modid);
	...
	public static final void registerPackets() {
		...
		registerMessage(DynamicLightsMessage.class);
	}
