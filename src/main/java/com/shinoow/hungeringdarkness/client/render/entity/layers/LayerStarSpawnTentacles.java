package com.shinoow.hungeringdarkness.client.render.entity.layers;

import java.util.UUID;

import com.shinoow.hungeringdarkness.client.model.player.ModelStarSpawnPlayer;
...
public class LayerStarSpawnTentacles implements LayerRenderer<EntityPlayer> {
	...
	private final ResourceLocation texture = new ResourceLocation("hungeringdarkness:textures/model/tentacles.png");
